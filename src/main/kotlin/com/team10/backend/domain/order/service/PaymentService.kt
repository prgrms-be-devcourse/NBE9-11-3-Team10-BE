...
class PaymentService(
    ...
    fun confirmPayment(request: ConfirmRequest, idempotencyKey: String): TossConfirmResponse {
        ...
        val response = orderConfirmService.sendConfirmRequest(request, idempotencyKey, null)
